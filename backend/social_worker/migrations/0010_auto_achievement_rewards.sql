...
CREATE TRIGGER auto_grant_coin_achievement_rewards
AFTER UPDATE OF games_played, wins, rating ON players
BEGIN
  -- First online win: Bronze +50
  UPDATE players
  ...
  -- Global rating 1500: Platinum +500
  UPDATE players
